      ...
      <div className="md:w-3/4 md:pl-4 md:m-auto">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center  md:m-8">
          <div className="md:mr-2">
            <input type="email" placeholder="I am looking for..." className="mt-2 w-3/4 md:w-full placeholder-gray-400/70 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
          </div>
          <div className="md:mr-2 mt-3 md:mt-0">
            <input type="password" placeholder="Area..." className="mt-2 w-3/4 md:w-full placeholder-gray-400/70 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
          </div>
          <div>
            <input type="password" placeholder="Amount..." className="mt-2 w-3/4 md:w-full placeholder-gray-400/70 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
          </div>
        </div>
      </div>
    </div>
