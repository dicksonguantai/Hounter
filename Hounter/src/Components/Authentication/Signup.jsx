export default function Signup(){
    ...
    <div className="flex justify-center min-h-screen">
        <div className="hidden bg-cover lg:block lg:w-2/5"  style={{backgroundImage: "url(/Images/Nairobiskyline.jpg)"}}>
        </div>
            ...
            <div className="w-full">
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-3 md:flex md:items-center md:-mx-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 50 50" stroke="currentColor" strokeWidth="2">
                ...
                <form className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                    ...
                    <a href="#" className="flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <span className="mx-2">Or Sign up with Google</span>
                        </a>
                </form>
            </div>
        </div>
